...
public record CarRequestDto(String model, String brand, String color, Year manufactureYear, Boolean replaceAdditionalAttributes,  Map<String, String> additionalAttributes) {
